...
public static class Program
{
    public static int Main(string[] args)
    {
        ...
        // Loopa tills vi lämnar med antingen break eller return
        while (true)
        {
            // Initiera task som ska användas senare
            Task? task = null;
            do
            {
                // Ge menyn av alternativ till användaren
                Console.Write("""
                              Alternativ:
    ...
    public static void AddOrEdit(List<string> data, string typeName)
    {
    ...
    public static void RandomizeTasks(Data data)
    {
    ...
    public static void LoadTasks(Data data)
    {
    ...
    public static void LoadPeople(Data data)
    {
        // Initierar variable där all text kommer vara
        string text;
        try
